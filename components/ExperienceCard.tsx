...
function ExperienceCard({ }: Props) {
	return (
		<article className='flex flex-col rounded-lg items-center space-y-7 max-w-3xl w-full snap-center bg-[#292929] p-10 hover:opacity-100
opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden'>
			<motion.img
				...
				className='w-32 h-32 rounded-full md:w-48 md:h-48 xl:w-[200px] xl:h-[200px] object-cover object-center'
			...
			<div className='px-0 md:px-10'>
				<h4 className='text-3xl font-light md:text-4xl'>CEO of VOSEKDBA</h4>
				<p className='font-bold text-xl md:text-2xl mt-1'>VOSEKDBA</p>
